...
tweets = []
for line in open('trainingTweets.txt').readlines():
...
print clf.predict(X)
tweets = []
for line in open('testingTweetsRandom.txt').readlines():
    tweets.append(json.loads(line))
